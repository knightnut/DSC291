...
ACCESS_KEY = 'qwteqwerqwer'
SECRET_KEY = 'astqwetawerwer'
bucket_name = "s3://your-bucket/"

os.system("pip install s3cmd")
os.system(f"s3cmd --access_key={ACCESS_KEY}--secret_key={SECRET_KEY}")
